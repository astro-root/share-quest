    ...
    <header className="sticky top-0 z-50 bg-[#0f1f3d] dark:bg-[#0a1628] border-b border-white/10 shadow-lg">
      <div className="max-w-6xl mx-auto px-5 py-0 flex items-center justify-between h-16">
        ...
        <Link href="/" className="flex items-center shrink-0 group">
          <Image src="/header.png" alt="SHARE Quest" width={240} height={64} className="h-14 w-auto object-contain group-hover:opacity-80 transition-opacity duration-200 brightness-150" priority />
        </Link>
